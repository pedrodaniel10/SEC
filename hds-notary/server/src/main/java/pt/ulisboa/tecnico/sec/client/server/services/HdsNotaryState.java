...
import pt.ulisboa.tecnico.sec.client.library.exceptions.GoodIsNotOnSale;
import pt.ulisboa.tecnico.sec.client.library.exceptions.GoodNotFoundException;
...
import pt.ulisboa.tecnico.sec.client.library.exceptions.TransactionDoesntExistsException;
...
public final class HdsNotaryState implements HdsNotaryService, Serializable {
     ...
     * @param requestNumber the client request number.
    ...
    public boolean intentionToSell(String sellerId, String goodId, int requestNumber,
        byte[] signature)
        throws GoodNotFoundException, GoodWrongOwner, UserNotFoundException, InvalidRequestNumberException,
    ...
    public Transaction intentionToBuy(String sellerId,
        ...
        int requestNumber,
        byte[] signature)
        throws GoodNotFoundException, GoodIsNotOnSale, GoodWrongOwner, UserNotFoundException,
    ...
    private void checkGood(String sellerId, String goodId, Good good)
        throws GoodIsNotOnSale, GoodWrongOwner {
        if (!good.isOnSale()) {
