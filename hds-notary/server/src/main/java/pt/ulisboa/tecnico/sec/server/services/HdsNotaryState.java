...
import pt.ulisboa.tecnico.sec.library.exceptions.*;
...
public final class HdsNotaryState implements HdsNotaryService, Serializable {
    ...
    public ImmutablePair<Good, byte[]> getStateOfGood(String userId, String goodId, String nonce, byte[] signature)
        ...
        PublicKey notaryPublicKey = CcUtils.getNotaryPublicKey();
    ...
    @Override
    public ImmutablePair<PublicKey, byte[]> getNotaryPublicKey() throws NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        byte[] signature = CryptoUtils.makeDigitalSignature(this.serverPrivateKey, new String(CcUtils.getNotaryPublicKey().getEncoded()));
    ...
    public void setPrivateKey(String privateKey) {
        ...
        this.serverPrivateKey = CryptoUtils.getPrivateKey(privateKey);
    }
