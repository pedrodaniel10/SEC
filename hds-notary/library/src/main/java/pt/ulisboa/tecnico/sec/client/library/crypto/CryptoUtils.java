package pt.ulisboa.tecnico.sec.client.library.crypto;
...
public final class CryptoUtils {
    ...
    public static byte[] makeDigitalSignature(PrivateKey privatekey, String... message)
        ...
        return CryptoUtils.makeDigitalSignature(messageConcat, privatekey);
    }

    /**
     * Verifies teh digital signature of the plain text
     *
     ...
     * @return the generated signature.
     */
    private static byte[] makeDigitalSignature(String plainText, PrivateKey privatekey)
        throws NoSuchAlgorithmException, InvalidKeyException, SignatureException {

        return CryptoUtils.makeDigitalSignature(plainText.getBytes(), privatekey);
    }
}
